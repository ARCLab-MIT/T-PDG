...
# Python NN helper functions
    ...
    constraints_model_path = "src/Models/transformer_model_vf_0_constraints_normalized.pt"
    time_model_path = "src/Models/transformer_model_vf_0_time_normalized.pt"
    constraints_data_path = "src/Data/standardized_test_dataset_constraints.pt"
    time_data_path = "src/Data/standardized_test_dataset_time.pt"
...
for inputs in test_dataloader
    ...
    if !isinf(soln.cost)
        ...
        jldsave("src/Results/T_PDG_results_test.jld2"; is_feasible, model_time_array, soln_array, soln_sim_array, rocket_array, strategy_time_array, feasibility_time_array, full_problem_time_array, is_feasible_reduced, is_feasible_check, total)

        plot_trajectory_gif_array(rocket_array, soln_array, soln_sim_array, "T-PDG Trajectory test")
    end
