...
function plot_thrust(rocket::Rocket, sol::Solution, sim::Solution)::Nothing
    ...
    fig.savefig("src/Results/rocket_landing_thrust_mag.png")
    ...
    fig.savefig("src/Results/rocket_landing_thrust_z.png")
...
function plot_mass(rocket::Rocket, sol::Solution, sim::Solution)::Nothing
    ...
    fig.savefig("src/Results/rocket_landing_mass.png")
...
function plot_velocity(rocket::Rocket, sol::Solution,
    ...
    fig.savefig("src/Results/rocket_landing_velocity.png")
...
function plot_pointing_angle(rocket::Rocket, sol::Solution,
    ...
    fig.savefig("src/Results/rocket_landing_angle.png")
...
function plot_position(rocket::Rocket, sol::Solution,
    ...
    fig.savefig("src/Results/rocket_landing_downrange_altitude.png")
    ...
    fig.savefig("src/Results/rocket_landing_crossrange_altitude.png")
...
function plot_trajectory_gif_array(rockets::Vector{Any}, sols::Vector{Any}, sims::Vector{Any}, name::String)::Nothing
    ...
    gif(gif_fig,"src/Results/"*name*".gif",fps=15)
